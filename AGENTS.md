...
作業を依頼するときは、毎回「○○サブエージェントを明示的に起動して」と書いてください。

例:

- 「frontend サブエージェントを明示的に起動して、商品一覧画面を確認してください」
- 「backend サブエージェントを明示的に起動して、商品APIを確認してください」
- 「database サブエージェントを明示的に起動して、MySQLのテーブル設計案を作ってください」
- 「frontend_design サブエージェントを明示的に起動して、トップページの見た目を検討してください」
...
サブエージェントを使う指示は、AGENTS.mdと毎回のプロンプトに書いてください。
